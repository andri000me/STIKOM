<?php
	...
	if(isset($_GET['absen'])){
		...
		if($statusmonev == "monev1"){
			...
			$mstatus  = "Pembekalan Mahasiswa KKN-PPM";
		}
									...
									<table class="table table-striped table-bordered table-hover">
										...
										?>
											<tr>
												...
												<td><center>
												<?php if(empty($status_absen)){ ?>
													<a href="?page=absen&aksi_pstatus=ubah_pstatus&jadwal=<?=$r_tjadwal['id_jadwal']?>&peserta=<?=$r_ypeserta['id_peserta']?>&status=hadir" class="label label-default" data-placement="left"  data-popup="tooltip" title="" data-original-title="Hadir"><i class="fa fa-check"></i></a>
													
													<a href="?page=absen&aksi_pstatus=ubah_pstatus&jadwal=<?=$r_tjadwal['id_jadwal']?>&peserta=<?=$r_ypeserta['id_peserta']?>&status=tidak" class="label label-default" data-placement="left"  data-popup="tooltip" title="" data-original-title="Tidak Hadir"><i class="fa fa-close"></i></a>
													
													<a data-placement="left" data-popup="tooltip" title="" data-original-title="Lainnya" href='#absenlainnya' id='custId' data-toggle='modal' data-id="<?php echo $r_ypeserta['id_peserta']; ?>" type="button" class="label label-default"><i class="fa fa-tasks"></i></a>
												<?php 
													}elseif(!empty($status_absen)){
