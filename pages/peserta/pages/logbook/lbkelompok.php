								...
								<table class="table table-striped table-bordered table-hover datatable-show-all">
									...
									<tbody>
										...
										<tr>
											...
											<td align="center">
												<a target="_blank" data-placement="left"  data-popup="tooltip" title="" data-original-title="Cetak" href="../../setting/include/report.php?logbook=<?=$r_lbkelompok['id_logbook'];?>&statuslb=<?=$statuslb;?>" type="button" class="label label-default"><i class="fa fa-print"></i></a>
											<?php if($status_peserta == "ketua"){ ?>
												<a data-placement="left"  data-popup="tooltip" title="" data-original-title="Ubah" href="?page=lbkelompok&ubah_lb=<?=$r_lbkelompok['id_logbook']?>" type="button" class="label label-primary"><i class="fa fa-edit"></i></a>
												
												<button data-placement="left"  data-popup="tooltip" title="" data-original-title="Hapus" onclick='datadel(<?php echo $r_lbkelompok['id_logbook']; ?>,&#39;lbkelompok&#39;)'  data-title='Delete' data-toggle='modal' data-target='#myModal' type="button" class="label label-danger"><i class="fa fa-trash"></i></button>
											<?php }elseif($status_peserta == "anggota"){ echo ""; }else{ echo ""; } ?>	
											</td>
										</tr>
										<?php  
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<input type="hidden" value="kelompok" name="status_logbook" />
												<a href="?page=lbkelompok" class="btn btn-danger btn-sm">Batal Simpan</a>
