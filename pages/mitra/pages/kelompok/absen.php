<?php
	...
	if(isset($_GET['absen'])){
		...
		$r_ujadwal    = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_jadwal WHERE id_kelompok='$id_kelompok' AND status_jadwal='monev3'")); 
		
		$statusmonev  = $r_ujadwal['status_jadwal'];
	...
	<div class="navbar-collapse collapse" id="navbar-filter">
		<div class="navbar-right">
			<ul class="nav navbar-nav">
				...
				<li class="<?=((empty($r_ujadwal['id_jadwal']) AND empty($mstatus))?'nopointer':'')?>"><a href="?page=nilai-km&absen=<?=$r_ujadwal['id_jadwal']?>&kelompok=<?=$id_kelompok?>&monev=<?=$mstatus;?>"><i class="fa fa-pencil"></i> Penilaian</a></li>
			</ul>
		</div>
	</div>
</div>
