<?php
	...
	$r_nilailpk    = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_nilai_uk_lpk WHERE id_kelompok='$r_tkelompok[id_kelompok]' AND id_dpl='$r_dpl[id_dpl]' AND status_nilai='nilailpk'"));  	
				...
				<div class="tab-pane fade in active" id="tab1">
					<div class="col-sm-3">
				    	...
				    	<div class="panel panel-white">
							...
							<div class="list-group-divider"></div>	
								<a href="?page=nilai-lpk&kelompok=<?=$id_kelompok;?>" class="list-group-item active"><i class="fa fa-file-text-o"></i> Laporan Pelaksanaan Kegiatan</a>
							<div class="list-group-divider"></div>	
					...
					<div class="col-sm-12">
						<div class="panel panel-white">
							<div class="panel-heading">
								<h6 class="panel-title">Nilai Keberhasilan Laporan Pelaksanaan</h6>
								<div class="heading-elements">
									<a target="_blank" href="../../setting/include/report.php?nlpkkelompok=<?=$id_kelompok;?>" type="button" class="btn btn-default btn-sm heading-btn"><i class="fa fa-print" style="margin-top:-4px;"></i> Cetak Nilai</a>
								</div>
							</div>
							<div class="panel-body">
								...
								<table class="table table-nobor-monev marbot10">
									<tr>
										<td>
											<table class="table table-nobor-monev">
												<tr>
													<th colspan="10">EVALUASI KEBERHASILAN LAPORAN PELAKSANAAN KKN-PPM MAHASISWA</th>
												</tr>
											</table>
										</td>
									</tr>
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th width="30"><center>
												<?php
													if(empty($r_nilailpk['nilai1']) AND empty($r_nilailpk['nilai2']) AND empty($r_nilailpk['nilai3'])){
												?>
												...
												<?php }elseif(!empty($r_nilailpk['nilai1']) AND !empty($r_nilailpk['nilai2']) AND !empty($r_nilailpk['nilai3'])){?>	
													<a data-placement="left"  data-popup="tooltip" title="" data-original-title="Ubah Nilai" href='#ubahnilaiuklpk' id='custId' data-toggle='modal' data-id="<?php echo $r_nilailpk['id_nilai']; ?>" type="button" class="label label-default"><i class="fa fa-edit"></i> Ubah</a>
												<?php }?>	
												</center></th>
										...
										<tbody>
											<tr>
												<td colspan="2">(I) Keberhasilan Program Yaitu Peluang, Kendala & Solusi (40%)</td>
