								...
								<?php if(isset($monev)){ echo ""; }else{?>
									<div class="heading-elements">										
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a target="_blank" href="../../setting/include/report.php?nkmdkelompok=<?=$id_kelompok;?>"><i class="fa fa-print" ></i> Nilai DPL</a></li>
										...
										?>
											<tr>
												...
												<td width="30" align="center">
													<a href="?page=nilai-km&absen=<?=$r_jadwal['id_jadwal']?>&kelompok=<?=$id_kelompok?>&monev=<?=$status_monev;?>" class="label label-default" data-placement="left"  data-popup="tooltip" title="" data-original-title="Cek Absen"><i class="fa fa-search-plus"></i> Cek</a>
												</td>
											</tr>
										<?php 
											} 
								...
								<div class="table-responsive">
									...
									<thead>	
										<tr>
											...
											<th rowspan="2" width="270"><center>Nama Mahasiswa</center></th>
											<th rowspan="2" width="80"><center>Absen</center></th>
											<th colspan="2"><center>Nilai Disiplin</center></th>
											<th colspan="2"><center>Nilai Kerjasama</center></th>
											<th rowspan="2" width="40"><center>Aksi</center></th>
										</tr>
										<tr>
									...
									<tbody>
										<?php
											...
											$r_nilaikmdpl = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_nilai_km WHERE id_peserta='$r_ypeserta[id_peserta]' AND id_dpl='$r_dpl[id_dpl]' AND id_jadwal='$r_tjadwal[id_jadwal]'"));
											
											$r_nilaikmdpl1 = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_nilai_km WHERE id_peserta='$r_ypeserta[id_peserta]' AND status_penilai='dpl1' AND id_jadwal='$r_tjadwal[id_jadwal]'"));
											
											$r_nilaikmdpl2 = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_nilai_km WHERE id_peserta='$r_ypeserta[id_peserta]' AND status_penilai='dpl2' AND id_jadwal='$r_tjadwal[id_jadwal]'"));												
											
											
											$nilaids_dpl1  = $r_nilaikmdpl1['nilai_ds'];
											$nilaids_dpl2  = $r_nilaikmdpl2['nilai_ds'];
											
											$nilaiks_dpl1  = $r_nilaikmdpl1['nilai_ks'];
											$nilaiks_dpl2  = $r_nilaikmdpl2['nilai_ks'];											
										...
										<tr>
											...
											<td><center><?=((empty($nilaids_dpl1))?'-':potong_nilai($nilaids_dpl1))?></center></td>
											<td><center><?=((empty($nilaids_dpl2))?'-':potong_nilai($nilaids_dpl2))?></center></td>
											<td><center><?=((empty($nilaiks_dpl1))?'-':potong_nilai($nilaiks_dpl1))?></center></td>
											<td><center><?=((empty($nilaiks_dpl2))?'-':potong_nilai($nilaiks_dpl2))?></center></td>
											<td><center>
											<?php
												if(empty($r_nilaikmdpl['nilai_ds']) AND empty($r_nilaikmdpl['nilai_ks'])){
											?>
											...
											<?php
												}elseif(!empty($r_nilaikmdpl['nilai_ds']) AND !empty($r_nilaikmdpl['nilai_ks'])){
											?>	
												<a data-placement="left"  data-popup="tooltip" title="" data-original-title="Ubah Nilai" href='#ubahnilaikm' id='custId' data-toggle='modal' data-id="<?php echo $r_nilaikmdpl['id_nilai']; ?>" type="button" class="label label-default"><i class="fa fa-edit"></i> Ubah</a>
											<?php } ?>
											</center></td>
										</tr>
										<?php } ?>
