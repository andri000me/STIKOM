<?php include '../../setting/include/mitra_control.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
<?php
...
?>
		...
		<?php 
			lib_css($page); 
			if($page == "kelompok-mitra" || $page == "absen-mitra" || $page == "dashboard"){
		?>
...
<body class="layout-boxed">
	<?php
		include '../../setting/include/mitra_firstnavbar.php';
		
		include '../../setting/include/mitra_secondnavbar.php';
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<?php 
					...
					include '../../setting/include/mitra_set_pages.php';
				?>
