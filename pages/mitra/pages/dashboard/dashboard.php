<?php
	...
	$q_tjadwal     = mysqli_query($dbconnect,"SELECT tbl_kelompok.id_kelompok, tbl_kelompok.id_lokasi, tbl_kelompok.nama_kelompok, tbl_kelompok.tahun_kkn, tbl_jadwal.id_jadwal, tbl_jadwal.id_kelompok, tbl_jadwal.tgl_jadwal, tbl_jadwal.status_jadwal FROM tbl_kelompok NATURAL JOIN tbl_jadwal WHERE  tbl_kelompok.id_kelompok='$r_xkelompok[id_kelompok]' AND tbl_jadwal.status_jadwal!='pembekalan' AND tbl_kelompok.tahun_kkn='$r_atur[tahun_kkn]' ORDER BY tbl_jadwal.tgl_jadwal ASC") or die (mysqli_error($dbconnect));
			...
			<div class="col-sm-12">
				...
				<div class="table-responsive">
					<table class="table text-nowrap">
						<thead>
							<tr class="active">
								<td colspan="4">Jadwal Monev KKN</td>
							</tr>
						</thead>
						<tbody>
						<?php 
						...
						?>
							<tr <?=(($r_tjadwal['tgl_jadwal']==$tglsekarang)?'style="background:rgba(255,191,191,0.3);"':'')?>>
								...
								<td class="text-center">
									<a href="?page=absen-mitra&absen=<?=$r_tjadwal['id_jadwal']?>" class="label label-default" data-placement="left"  data-popup="tooltip" title="" data-original-title="Cek Absen"><i class="fa fa-search-plus"></i> Cek</a>
								</td>
							</tr>
						<?php endwhile; ?>	
						</tbody>
			...
			<div class="panel panel-flat">
				<div class="table-responsive">
					<table class="table text-nowrap">
						<thead>
							<tr class="active">
								<td colspan="5">Anggota Kelompok Bimbingan</td>
							</tr>
						</thead>
						<tbody>
							<?php
