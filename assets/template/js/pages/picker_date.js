...
$(function() {
    ...
    // Time limits
    $('.pickatime-limits1').pickatime({
        min: [7,30],
        max: [14,0]
    });
	$('.pickatime-limits2').pickatime({
        min: [7,30],
        max: [14,0]
    });
	...
	$("#anytime-time4").AnyTime_picker({
        format: "%H:%i"
    });
	
	$("#anytime-time5").AnyTime_picker({
        format: "%H:%i"
    });
	
	$("#anytime-time6").AnyTime_picker({
        format: "%H:%i"
    });
	
	$("#anytime-time7").AnyTime_picker({
        format: "%H:%i"
    });
	
	$("#anytime-time8").AnyTime_picker({
        format: "%H:%i"
    });
