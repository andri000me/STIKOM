								...
								<div class="table-responsive">
									...
									<tbody>
										<?php
											...
											$r_nilaipldpl = mysqli_fetch_array(mysqli_query($dbconnect,"SELECT * FROM tbl_nilai_pl WHERE id_peserta='$r_ypeserta[id_peserta]' AND id_dpl='$r_dpl[id_dpl]' AND id_jadwal='$r_tjadwal[id_jadwal]'"));
										...
										<tr>
											...
											<td><center>
											<?php if(empty($r_nilaipldpl['nilai_pl'])){?>
												<a data-placement="left"  data-popup="tooltip" title="" data-original-title="Masukan Nilai" href='#nilaipl' id='custId' data-toggle='modal' data-id="<?php echo $r_ypeserta['id_peserta']; ?>" type="button" class="label label-default <?=cek_status5($status_absen);?>"><i class="fa fa-pencil"></i> Nilai</a>
											<?php }else{ ?>	
												<a data-placement="left"  data-popup="tooltip" title="" data-original-title="Ubah Nilai" href='#ubahnilaipl' id='custId' data-toggle='modal' data-id="<?php echo $r_nilaipldpl['id_nilai']; ?>" type="button" class="label label-default"><i class="fa fa-edit"></i> Ubah</a>
											<?php } ?>	
											</center></td>
										</tr>
										<?php } ?>
